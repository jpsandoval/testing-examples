...
class AbstractProfiler:
    ...
    def record(cls, functionName,args):
        cls.getInstance().fun_call_record(functionName,args)

    def fun_call_record(self):
        pass
    ...
    def instrument(cls,ast):
        ...
        transformedAst=  visitor.visit(ast)
        #print(unparse(transformedAst))
        return  fix_missing_locations(visitor.visit(transformedAst))
